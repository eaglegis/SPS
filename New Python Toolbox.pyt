...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [SamplesExportTool,ReloadModules]
...
class SamplesExportTool(CommonTool):
    ...
    def execute(self, parameters, messages):
        ...
        # check selection coming through - object ids
        # check datasource - can we get item id from that? - should be able to - get portal connection from pro?
        ...
        # assumption is that the relationship id 0 - will need to update this as we go forward
...
class ReloadModules(CommonTool):
    ...
    def execute(self, parameters, messages):
        ...
        modules = [ArcGISOnlineHelper,SPSXMLExport]
        for x in modules:
