...
class disorderType(GeneratedsSuper):
    ...
    def __init__(self, name=None, comments=None, agent=None, aspect=None, terrain=None, position=None, type_=None, severity=None, severityPercent=None, extent=None, incidencePercent=None, isSampleTaken=None):
        ...
        self.severityPercent = severityPercent
        self.extent = extent
    ...
    def get_severityPercent(self): return self.severityPercent
    def set_severityPercent(self, severityPercent): self.severityPercent = severityPercent
    ...
    def hasContent_(self):
        if (
            ...
            self.severityPercent is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='disorderType', fromsubclass_=False, pretty_print=True):
        ...
        if self.severityPercent is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<severityPercent>%s</severityPercent>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.severityPercent), input_name='severityPercent')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'severityPercent':
            severityPercent_ = child_.text
            severityPercent_ = self.gds_validate_string(severityPercent_, node, 'severityPercent')
            self.severityPercent = severityPercent_
